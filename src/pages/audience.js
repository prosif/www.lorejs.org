...
export default (props) => {
  ...
  return (
    <Template>
      ...
      <ol>
        <li>
          The first is to provide a **safe environment** for you to become comfortable building React applications, by letting
          you focus on learning React, and not getting bogged down by all the challenges associated with architecture.
        </li>
        <li>
          The second goal is to **teach good architectural practices**. The patterns and conventions Lore uses come from years
      ...
      <p>
        ...
        and architectural patterns, you can check out the <Link to="/architecture/">architecture documentation</Link> for an explanation and
      ...
      <ol>
        <li>
          The first is to **demonstrate what's possible with Redux**. At it's core, Lore is not "some new way of developing
        ...
        <li>
          The second goal is to **demonstrate a cohesive and holistic architecture** that is **able to solve for all common
      ...
      <p>
        So if you want to see what's possible with Redux, Lore might be of interest to you. And if you want to learn
        how it all works, and about the reasoning behind the patterns Lore uses, you can check out
        the <Link to="/architecture/">architecture documentation</Link> for an explanation and demystification of the framework.
      </p>
