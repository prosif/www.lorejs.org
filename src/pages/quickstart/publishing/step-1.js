...
export default (props) => {
  return (
    <Template>
      ...
      <p>
        Go ahead an execute <code>npm run build</code> from the command line. You should see output similar to this
        once it completes, which took 15 seconds for this example:
      </p>
      ...
      <ul>
        <li>
          ...
          Webpack config only generates favicons for the webpack, but you can also
          modify <code>webpack.config.js</code> to generate favicons for devices like Apple, Android and Windows.
        </li>
        <li>
      ...
      <p>
        Next run <code>npm run build:prod</code>. You should see output similar to this once it completes, which
      ...
      <p>
        The intent of the <code>npm run build</code> command is to enable you to quickly generate a production build,
        and verify it works, or work out any issues. Then, once everything looks good, you can run the <code>npm run
        build:prod</code> command to minify and uglify the code for the real and final test before pushing to
        production.
      </p>
