  ...
  return (
    <Template>
      ...
      <p>
        ...
        you launch to perform a task, and may reuse in multiple places in the application.
      </p>
      ...
      <ol>
        ...
        <li>
          By making sure the Redux <code>store</code> exists in context, the dialogs (or any dialogs steps) will be able to make use of
          <code>lore.connect</code> to request data, fire actions, and get notified when the store updates.
        </li>
      </ol>
